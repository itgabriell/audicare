  ...
  return (
    <>
      ...
      <div className="h-full flex flex-col space-y-6 overflow-hidden pr-2">
        {/* Header Floating */}
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 md:gap-4 py-1">
          <div>
        ...
        <div className="flex flex-col md:flex-row gap-2 md:gap-4 items-center bg-white/60 dark:bg-slate-900/60 backdrop-blur-md p-2 md:p-3 rounded-3xl border border-slate-200/50 dark:border-slate-800/50 shadow-sm z-10 shrink-0">
