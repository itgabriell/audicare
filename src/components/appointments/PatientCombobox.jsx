...
export function PatientCombobox({ patients = [], value, onChange, onPatientsUpdate, initialSearchTerm = "", initialPhone = "" }) {
  ...
  const openRegistrationModal = () => {
    setNewPatientData({ name: searchTerm, phone: initialPhone, email: "" });
    setOpen(false);
